...
return [
    /*
     * Habilita la documentación Swagger/OpenAPI. En producción conviene
     * ponerlo en false (SCRAMBLE_ENABLED=false); AppServiceProvider omite el
     * registro de las rutas /docs/api y /docs/api.json cuando está apagado.
     */
    ...
    'info' => [
         ...
         */
        'description' => 'API REST de facturación electrónica de Costa Rica (Hacienda v4.4). '
            .'Autenticación por token Bearer (Sanctum): use POST /api/v1/auth/login '
            .'(usuario master) o /api/v1/auth/company/login (sub-usuario de empresa).',
    ],
